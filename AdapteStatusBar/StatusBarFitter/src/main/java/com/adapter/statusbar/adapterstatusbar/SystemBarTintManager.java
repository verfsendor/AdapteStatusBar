...
public class SystemBarTintManager {
    ...
    static {
        try {
            ...
            mMiuiVersion = (String) getStringMethod.invoke(sysClass, "ro.miui.ui.version.name");
            sIsMiuiV6 = "V6".equals(mMiuiVersion);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }

    static public String getMiuiVerison() {
        return mMiuiVersion;
    }
    ...
    /**
     * Is tinting available for the system status bar?
     *
     * @return True if enabled, False otherwise.
     */
    public boolean isStatusBarTintAvailable() {
